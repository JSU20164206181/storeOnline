                ...
                <div class="row product-list">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="product-item">
                            ...
                            <a href="javascript:;" onclick="addShopCar(${goods.gpId},${goods.gpUid})" class="btn btn-default add2cart">添加购物车</a>
                        </div>
                    </div>
                    </c:forEach>
                    <!-- PRODUCT ITEM END -->
                    ...
                    <c:forEach items="${goodsList}" begin="4" end="7" var="goods">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="product-item">
                                ...
                                <a href="javascript:;" onclick="addShopCar(${goods.gpId},${goods.gpUid})"  class="btn btn-default add2cart">添加到购物车</a>
                            </div>
                        </div>
                    </c:forEach>
                    <!-- PRODUCT ITEM END -->
                        ...
                        <ul class="pagination pull-right">
                            <li>
                                <c:choose>
                                    <c:when test="${currentPage>1}">
                                        <a href="showUserGoods.action?userId=${goodsList[0].gpUid}&page=${currentPage-1}">&laquo;</a>
                                    </c:when>
                                    <c:otherwise>
                            ...
                            <c:forEach var="i" begin="${begin}" end="${end}">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li><a href="showUserGoods.action?userId=${goodsList[0].gpUid}&page=${i}">${i}</a></li>
                                    </c:otherwise>
                                </c:choose>
                            ...
                            <c:choose>
                                <c:when test="${currentPage<totalPage}">
                                    <a href="showUserGoods.action?userId=${goodsList[0].gpUid}&page=${currentPage+1}">&raquo;</a>
                                </c:when>
                                <c:otherwise>
