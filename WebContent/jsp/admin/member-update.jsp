	...
	<form  method="post" class="form form-horizontal" id="form-member-update">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=userId%>" readOnly=true placeholder="" id="userId" name="userId">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.mail }" placeholder="@" name="mail" id="mail">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	var data = $('#form-member-update').serialize();
	console.log(data);
