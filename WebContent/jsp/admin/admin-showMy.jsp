...
<c:if test="${sessionScope.adminName!=null }">
	<form action="/" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> ${admin.gaId } </div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> ${admin.gaPassword }</div> 
		</div>
		<div class="row cl">
			...
			普通管理员</c:if>
			<c:if test="${admin.gaRank ==9}">超级管理员</c:if>  
			</div>
		</div> 		
	</form>
	</c:if>
