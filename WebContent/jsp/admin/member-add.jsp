...
<article class="page-container">
	<form action="../UserUpdateServlet" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>ID：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=id%>" readOnly=true placeholder="" id="number" name="number">
			</div>
		</div>
		<div class="row cl">
