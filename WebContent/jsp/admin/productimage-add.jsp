...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: 'uploadProductimage.action',
            // runtimeOrder: 'flash',
        ...
        uploader.on( 'uploadSuccess', function( file , response) {
    		...
    		if(response.status == "success"){
    			imagePath = response.filePath;//获取每次上传图片的名称
    			img.push(response.filePath);//将所有上传图片的名称放到一个数组里面
