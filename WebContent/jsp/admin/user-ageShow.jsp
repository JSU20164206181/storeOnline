...
﻿﻿$(function () {	
    $('#container').highcharts({
        ...
        title: {
            text: '用户年龄分布(共${ageCount.get("all")} 人) '
        ...
        series: [{
            ...
            name: '所占比例', 
            data: [       
                ["儿童(1~6): ${ageCount.get('童年')}人",   "${ageCount.get('童年')}"/"${ageCount.get('all')}"],   
                ["少年(7~17): ${ageCount.get('少年')}人",  "${ageCount.get('少年')}"/"${ageCount.get('all')}"],   
                ["青年(18~40): ${ageCount.get('青年')}人", "${ageCount.get('青年')}"/"${ageCount.get('all')}"],   
                ["中年(41~65): ${ageCount.get('中年')}人", "${ageCount.get('中年')}"/"${ageCount.get('all')}"],   
                ["老年(>66): ${ageCount.get('老年')}人",   "${ageCount.get('老年')}"/"${ageCount.get('all')}"],   
